...
```
java -jar lighty-toaster-multiple-devices-24.1.0-SNAPSHOT.jar --starting-port 20000 --device-count 200 --thread-pool-size 200
```
...
`java -jar lighty-toaster-multiple-devices-24.1.0-SNAPSHOT.jar -i path/to/persistence/directory -o path/to/persistence/directory`
