...
```
java -jar lighty-toaster-multiple-devices-24.0.0.jar --starting-port 20000 --device-count 200 --thread-pool-size 200
```
...
`java -jar lighty-toaster-multiple-devices-24.0.0.jar -i path/to/persistence/directory -o path/to/persistence/directory`
