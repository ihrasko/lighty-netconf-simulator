...
```
java -jar lighty-network-topology-device-24.0.0.jar
```
...
```
java -jar lighty-network-topology-device-24.0.0.jar 12345
```
...
`java -jar lighty-network-topology-device-24.0.0.jar -i path/to/persistence/directory -o path/to/persistence/directory`
