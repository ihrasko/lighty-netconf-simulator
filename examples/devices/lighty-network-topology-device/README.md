...
```
java -jar lighty-network-topology-device-24.1.0-SNAPSHOT.jar
```
...
```
java -jar lighty-network-topology-device-24.1.0-SNAPSHOT.jar 12345
```
...
`java -jar lighty-network-topology-device-24.1.0-SNAPSHOT.jar -i path/to/persistence/directory -o path/to/persistence/directory`
